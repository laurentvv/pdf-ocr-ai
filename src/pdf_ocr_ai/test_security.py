...
def test_security_logging():
    ...
    provider = OpenAICompatibleProvider(base_url="http://localhost:1234/v1", api_key=sensitive_key)
    ...
    print("✓ Security logging test passed: Sensitive information was not leaked to logs.")
